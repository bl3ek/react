...
// Стилі для сторінки Моє Місто (city.tsx)
...
// Стилі для сторінки Пам'яток (sights.tsx)
...
// Стилі для панелі вкладок / Таб-бару (app/(tabs)/_layout.tsx)
...
// Стилі для екрана новин News (app/(tabs)/index.tsx)
...
// Стилі для екрана налаштувань Settings (app/(tabs)/settings.tsx)
